...
public class LevelManager : MonoBehaviour
{
    ...
    [SerializeField] private TextMeshProUGUI _statusInfo;

    [SerializeField] private TextMeshProUGUI _livesInfo;

    [SerializeField] private TextMeshProUGUI _totalEnemyInfo;
    ...
    //fungsi ini akan menghapus object spawned tower dari list yang ada
    public void EraseThisTower(Tower tobeErased)
    {
        _spawnedTowers.Remove(tobeErased);
    }
}
